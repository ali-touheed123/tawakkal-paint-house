...
export default function ProductDetailPage() {
    ...
    const shadeCardPdf = useMemo(() => {
        ...
        if (brand === 'Berger' && name.toLowerCase().includes('top super emulsion')) return '/pdfs/berger_top_super_emulsion.pdf';
                                                                                                                                                                            ...
                                                                                                                                                                            : isBergerSuperiorMattFinish ? BERGER_SUPERIOR_MATT_FINISH_SHADES
                                                                                                                                                                                : isBergerWeatherCoatGlow365 ? BERGER_WEATHER_COAT_GLOW_365_SHADES
                                                                                                                                                                                    : isBergerVipWeatherCoat ? BERGER_VIP_WEATHER_COAT_SHADES
                                                                                                                                                                                        ...
                                                                                                                                                                                        : isBergerTopSuperEmulsion ? BERGER_TOP_SUPER_EMULSION_SHADES
