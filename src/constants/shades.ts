...
export const GOBIS_GOLD_LUXURIOUS_WALL_EMULSION_SHADES: Shade[] = [
  ...
  { id: 'ggl-1401', product_id: '', name: 'Off White', code: '1401', hex: '#FAF9F6', is_drum_available: false },
  { id: 'ggl-1402', product_id: '', name: 'Magnolia', code: '1402', hex: '#F3E5AB', is_drum_available: false },
  { id: 'ggl-1403', product_id: '', name: 'Soft Silk', code: '1403', hex: '#F2F0E6', is_drum_available: false },
  { id: 'ggl-1404', product_id: '', name: 'Cool White', code: '1404', hex: '#F5F5F5', is_drum_available: false },
  { id: 'ggl-1406', product_id: '', name: 'Twilight', code: '1406', hex: '#E4E0E9', is_drum_available: false },
  { id: 'ggl-1407', product_id: '', name: 'Cockleshell', code: '1407', hex: '#FFCBA4', is_drum_available: false },
  { id: 'ggl-1408', product_id: '', name: 'White Pepper', code: '1408', hex: '#EAE0C8', is_drum_available: false },
  { id: 'ggl-1409', product_id: '', name: 'Ivory Silk', code: '1409', hex: '#F2E5D7', is_drum_available: false },
  { id: 'ggl-1452', product_id: '', name: 'Moon Flower', code: '1452', hex: '#F8F8FF', is_drum_available: false },
  { id: 'ggl-1453', product_id: '', name: 'Porcelain', code: '1453', hex: '#FAEBD7', is_drum_available: false },
  { id: 'ggl-1458', product_id: '', name: 'Ash White', code: '1458', hex: '#E8E4DE', is_drum_available: false },
  { id: 'ggl-1471', product_id: '', name: 'Zephyr', code: '1471', hex: '#D0D0D0', is_drum_available: false },
  { id: 'ggl-1473', product_id: '', name: 'Cameo', code: '1473', hex: '#EFDECD', is_drum_available: false },
  { id: 'ggl-1434', product_id: '', name: 'Whisper', code: '1434', hex: '#F2F0E6', is_drum_available: false },

  // Creams & Browns
  { id: 'ggl-1405', product_id: '', name: 'Cream', code: '1405', hex: '#FFFDD0', is_drum_available: false },
  { id: 'ggl-1410', product_id: '', name: 'Honey Milk', code: '1410', hex: '#F1E9D2', is_drum_available: false },
  { id: 'ggl-1411', product_id: '', name: 'Badami', code: '1411', hex: '#E9DCC9', is_drum_available: false },
  { id: 'ggl-1412', product_id: '', name: 'Peach Goddess', code: '1412', hex: '#FFDAB9', is_drum_available: false },
  { id: 'ggl-1413', product_id: '', name: 'Desert Dawn', code: '1413', hex: '#F4A460', is_drum_available: false },
  { id: 'ggl-1415', product_id: '', name: 'Wild Earl', code: '1415', hex: '#D2B48C', is_drum_available: false },
  { id: 'ggl-1416', product_id: '', name: 'Hopsack', code: '1416', hex: '#B08D57', is_drum_available: false },
  { id: 'ggl-1417', product_id: '', name: 'Romantic', code: '1417', hex: '#FBD7D1', is_drum_available: false },
  { id: 'ggl-1421', product_id: '', name: 'Chocolate', code: '1421', hex: '#7B3F00', is_drum_available: false },
  { id: 'ggl-1433', product_id: '', name: 'Apricot', code: '1433', hex: '#FBCEB1', is_drum_available: false },
  { id: 'ggl-1455', product_id: '', name: 'Peach', code: '1455', hex: '#FFE5B4', is_drum_available: false },
  { id: 'ggl-1456', product_id: '', name: 'Bow Bells', code: '1456', hex: '#FFC0CB', is_drum_available: false },
  { id: 'ggl-1470', product_id: '', name: 'Sand Stone', code: '1470', hex: '#C2B280', is_drum_available: false },
  { id: 'ggl-1465', product_id: '', name: 'Terracotta', code: '1465', hex: '#E2725B', is_drum_available: false },
  { id: 'ggl-1461', product_id: '', name: 'Wood Berry', code: '1461', hex: '#966D5B', is_drum_available: false },

  // Pinks & Reds
  { id: 'ggl-1414', product_id: '', name: 'Fresh Orange', code: '1414', hex: '#FF8C00', is_drum_available: false },
  { id: 'ggl-1418', product_id: '', name: 'Deep Pink', code: '1418', hex: '#FF1493', is_drum_available: false },
  { id: 'ggl-1419', product_id: '', name: 'Swiss Miss', code: '1419', hex: '#F3E5AB', is_drum_available: false },
  { id: 'ggl-1420', product_id: '', name: 'Bright Red', code: '1420', hex: '#FF0000', is_drum_available: false },
  { id: 'ggl-1428', product_id: '', name: 'Pink Violet', code: '1428', hex: '#E0B0FF', is_drum_available: false },
  { id: 'ggl-1429', product_id: '', name: 'Carnival Pink', code: '1429', hex: '#FF69B4', is_drum_available: false },
  { id: 'ggl-1447', product_id: '', name: 'Cherry Blossom Pink', code: '1447', hex: '#FFB7C5', is_drum_available: false },
  { id: 'ggl-1460', product_id: '', name: 'Red', code: '1460', hex: '#FF0000', is_drum_available: false },
  { id: 'ggl-1467', product_id: '', name: 'Tea Rose', code: '1467', hex: '#F4C2C2', is_drum_available: false },
  { id: 'ggl-1469', product_id: '', name: 'Pink', code: '1469', hex: '#FFC0CB', is_drum_available: false },

  // Greens
  { id: 'ggl-1424', product_id: '', name: 'Fresh Green', code: '1424', hex: '#90EE90', is_drum_available: false },
  { id: 'ggl-1425', product_id: '', name: 'Lime Light', code: '1425', hex: '#E3F9A6', is_drum_available: false },
  { id: 'ggl-1427', product_id: '', name: 'Pastel Green', code: '1427', hex: '#77DD77', is_drum_available: false },
  { id: 'ggl-1463', product_id: '', name: 'Green Summit', code: '1463', hex: '#006B3C', is_drum_available: false },
  { id: 'ggl-1472', product_id: '', name: 'Forest Green', code: '1472', hex: '#228B22', is_drum_available: false },

  // Blues & Purples
  { id: 'ggl-1422', product_id: '', name: 'Health Violet', code: '1422', hex: '#D8BFD8', is_drum_available: false },
  { id: 'ggl-1430', product_id: '', name: 'Electric Blue', code: '1430', hex: '#7DF9FF', is_drum_available: false },
  { id: 'ggl-1436', product_id: '', name: 'Sea Wind', code: '1436', hex: '#B0E0E6', is_drum_available: false },
  { id: 'ggl-1437', product_id: '', name: 'Celestical', code: '1437', hex: '#AFDBF5', is_drum_available: false },
  { id: 'ggl-1438', product_id: '', name: 'Ice Age', code: '1438', hex: '#F0F8FF', is_drum_available: false },
  { id: 'ggl-1439', product_id: '', name: 'Blue Heaven', code: '1439', hex: '#87CEEB', is_drum_available: false },
  { id: 'ggl-1459', product_id: '', name: 'Blue', code: '1459', hex: '#0000FF', is_drum_available: false },
  { id: 'ggl-1462', product_id: '', name: 'Purple', code: '1462', hex: '#800080', is_drum_available: false },

  // Greys & Misc
  { id: 'ggl-1423', product_id: '', name: 'Sherbet', code: '1423', hex: '#F5F5DC', is_drum_available: false },
  { id: 'ggl-1426', product_id: '', name: 'Classical Tint', code: '1426', hex: '#FFF8E7', is_drum_available: false },
  { id: 'ggl-1431', product_id: '', name: 'Winter Willow', code: '1431', hex: '#E1EBDA', is_drum_available: false },
  { id: 'ggl-1432', product_id: '', name: 'Citrus Yellow', code: '1432', hex: '#F0E130', is_drum_available: false },
  { id: 'ggl-1435', product_id: '', name: 'Goose Wing', code: '1435', hex: '#BAC4C8', is_drum_available: false },
  { id: 'ggl-1444', product_id: '', name: 'Orchard Lane', code: '1444', hex: '#90EE90', is_drum_available: false },
  { id: 'ggl-1445', product_id: '', name: 'Mallow', code: '1445', hex: '#D8BFD8', is_drum_available: false },
  { id: 'ggl-1446', product_id: '', name: 'Classical', code: '1446', hex: '#FDF5E6', is_drum_available: false },
  { id: 'ggl-1464', product_id: '', name: 'Ice Grey', code: '1464', hex: '#D3D3D3', is_drum_available: false },
  { id: 'ggl-1466', product_id: '', name: 'Parasol', code: '1466', hex: '#EFDECD', is_drum_available: false },
  { id: 'ggl-1468', product_id: '', name: 'Dove Grey', code: '1468', hex: '#6D9BC3', is_drum_available: false },
];
